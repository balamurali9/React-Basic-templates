    ...
    render(){
        return (
        	<div>
        		<h2>Help</h2>
        		<p>
					US11442 - [Tech Story] Capture all configs in a tenant
				</p>
				<p>
					As a User/ L2 support i need a UI dashboard to view all configurations in CK from database and configurations files for any given tenant in a specific environment
				</p>
				<p>
					Inscope:
					System should have an ability to capture all configurations for any given tenant in an environment from the database and configuration files.
				</p>
				<p>
				...
				<p>
					Note: Please refer to the attachment for details of configuration collections-in progress from database and configurations file, tenants, environments for your reference.
				</p>
				<p>
					Acceptance criteria:
					Given i am a L2 support user when i access the configuration dashboard view then i should be able to read all the configurations of any tenant in an environment.
					Given i am a L2 support user when i access the configuration dashboard view then i should be able to filter through the configurations of any tenant in an environment.(User will then filter through the configurations data by choosing the tenant->components->database/ Configurations file).
				</p>
        	</div>
        );
    }
